...
var UserWhere = struct {
	...
	ID:        whereHelperint64{field: "\"users\".\"users\".\"id\""},
	Username:  whereHelperstring{field: "\"users\".\"users\".\"username\""},
	Email:     whereHelperstring{field: "\"users\".\"users\".\"email\""},
	Password:  whereHelperstring{field: "\"users\".\"users\".\"password\""},
	CreatedAt: whereHelpertime_Time{field: "\"users\".\"users\".\"created_at\""},
	LastLogin: whereHelpernull_Time{field: "\"users\".\"users\".\"last_login\""},
}
...
var (
	userAllColumns            = []string{"id", "username", "email", "password", "created_at", "last_login"}
	userColumnsWithoutDefault = []string{"username", "email", "password"}
	userColumnsWithDefault    = []string{"id", "created_at", "last_login"}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"users\".\"users\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"users\".\"users\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"users\".\"users\" where \"id\"=$1", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"users\".\"users\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"users\".\"users\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"users\".\"users\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"users\".\"users\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"users\".\"users\"", updateOnConflict, ret, update, conflict, insert)
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"users\".\"users\" WHERE " +
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"users\".\"users\".* FROM \"users\".\"users\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users\".\"users\" where \"id\"=$1 limit 1)"
